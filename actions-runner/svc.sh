...
SVC_NAME="actions.runner.Khalilz00-hackathon-starter.LAPTOP-4A6L98RC.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Khalilz00-hackathon-starter.LAPTOP-4A6L98RC)"
